...
cis_nofsimage:
	...
	$(PROJ_ROOT)/image/makefiletools/bin/pnigenerator -s 64 -p 2048 -b 64 -k 2048 -u 8 -l 0x20000 -t "$(cis$(PATSIZE))(CIS),$(cis$(BOOTTAB))" -y "$(cis$(SYSTAB))" -o $(IMAGEDIR)/boot/PARTINFO.pni
...
rootfs_bak_$(FLASH_TYPE)_ramfs_fsimage:
	@echo [[$@]]
	cd $(PROJ_ROOT)/kbuild/$(KERNEL_VERSION);./scripts/gen_initramfs_list.sh -o $(IMAGEDIR)/rootfs_bak.ramfs -u 0 -g 0 $(OUTPUTDIR)/rootfs_bak/
