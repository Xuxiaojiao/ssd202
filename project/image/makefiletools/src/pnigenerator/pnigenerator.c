...
#define UNFD_PART_OTA			0x1E
#define UNFD_PART_MEDIA			0x1D
...
static u16 FindPartTypeByName(const char* partName)
{
	 ...
	 else if(strcmp(partName, "ota") == 0 )
         return UNFD_PART_OTA;
	 else if(strcmp(partName, "media") == 0 )
         return UNFD_PART_MEDIA;
