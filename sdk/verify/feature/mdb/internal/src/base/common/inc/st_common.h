...
#define ST_DBG(fmt, args...) ({do{printf(COLOR_GREEN);printf("[DBG]:%s[%d]: ", __FUNCTION__,__LINE__);printf(COLOR_NONE);printf(fmt, ##args);}while(0);})
#define ST_WARN(fmt, args...) ({do{printf(COLOR_YELLOW);printf("[DBG]:%s[%d]: ", __FUNCTION__,__LINE__);printf(COLOR_NONE);printf(fmt, ##args);}while(0);})
#define ST_INFO(fmt, args...) ({do{printf(COLOR_CYAN);printf("[DBG]:%s[%d]: ", __FUNCTION__,__LINE__);printf(COLOR_NONE);printf(fmt, ##args);}while(0);})
#define ST_ERR(fmt, args...) ({do{printf(COLOR_RED);printf("[DBG]:%s[%d]: ", __FUNCTION__,__LINE__);printf(COLOR_NONE);printf(fmt, ##args);}while(0);})
