...
static MI_RGN_ChnPortParam_t _gstChnPortParam ;
static MI_RGN_ChnPortParam_t _gstChnPortParamOsd;
...
Mdb_Region::Mdb_Region()
{
    ...
    PREPARE_COMMAND("onechnoneportsetbitmap", &Mdb_Region::OneChnOnePortSetBitmap, 3);
    ...
    PREPARE_COMMAND("test6", &Mdb_Region::TestCase006, 2);
    PREPARE_COMMAND("test7", &Mdb_Region::TestCase007, 1);
    PREPARE_COMMAND("test8", &Mdb_Region::TestCase008, 0);
    PREPARE_COMMAND("test9", &Mdb_Region::TestCase009, 0);
    PREPARE_COMMAND("test10", &Mdb_Region::TestCase010, 0);
...
void Mdb_Region::AutoTest(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    ...
    while(u8ExeCnt--)
    {
        ...
        TestCase001(inStrings, strOut, 0);

        // testcase002
        strOut += "create[x1024(cover&osd)] -> destroy[x1024]\n";
        TestCase002(inStrings, strOut, 0);

        // testcase003
        strOut += "create[osd] -> attach -> dettach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("0 0", vecStrIn);
        TestCase003(vecStrIn, strOut, 0);

        strOut += "create[osd] -> attach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("0 1", vecStrIn);
        TestCase003(vecStrIn, strOut, 0);

        strOut +=  "create[cover] -> attach -> dettach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("1 0", vecStrIn);
        TestCase003(vecStrIn, strOut, 0);

        strOut += "create[cover] -> attach -> destroy\n";
        vecStrIn.clear();
        ...
        strOut += "create[osd] -> attach[ldc MxN] -> dettach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("0 2", vecStrIn);
        TestCase004(vecStrIn, strOut, 0);
        ...
        strOut += "create[cover] -> attach[divp MxN] -> dettach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("1 1", vecStrIn);
        TestCase004(vecStrIn, strOut, 0);

        strOut += "create[cover] -> attach[ldc MxN] -> dettach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("1 2", vecStrIn);
        TestCase004(vecStrIn, strOut, 0);

        // testcase005
        strOut += "create[osd*max] -> attach[vpe] -> dettach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("0 0", vecStrIn);
        TestCase005(vecStrIn, strOut, 0);

        strOut += "create[osd*max] -> attach[divp] -> dettach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("0 1", vecStrIn);
        TestCase005(vecStrIn, strOut, 0);

        strOut += "create[osd*max] -> attach[ldc] -> dettach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("0 2", vecStrIn);
        TestCase005(vecStrIn, strOut, 0);

        strOut += "create[cover*max] -> attach[vpe] -> dettach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("1 0", vecStrIn);
        TestCase005(vecStrIn, strOut, 0);

        strOut += "create[cover*max] -> attach[divp] -> dettach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("1 1", vecStrIn);
        TestCase005(vecStrIn, strOut, 0);

        strOut += "create[cover*max] -> attach[ldc] -> dettach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("1 2", vecStrIn);
        TestCase005(vecStrIn, strOut, 0);
        ...
        vecStrIn.clear();
        ParseStrings("0 0", vecStrIn);
        TestCase006(vecStrIn, strOut, 0);

        strOut += "create[osd] -> setbitmap -> attach[vpe] -> destroy\n";
        vecStrIn.clear();
        ParseStrings("0 1", vecStrIn);
        TestCase006(inStrings, strOut, 0);

        strOut += "create[osd] -> attach[divp] -> setbitmap -> destroy\n";
        vecStrIn.clear();
        ParseStrings("1 0", vecStrIn);
        TestCase006(inStrings, strOut, 0);


        strOut += "create[osd] -> setbitmap -> attach[divp] -> destroy\n";
        vecStrIn.clear();
        ParseStrings("1 1", vecStrIn);
        TestCase006(vecStrIn, strOut, 0);

        strOut += "create[osd] -> attach[ldc] -> setbitmap -> destroy\n";
        vecStrIn.clear();
        ParseStrings("2 0", vecStrIn);
        TestCase006(inStrings, strOut, 0);

        strOut += "create[osd] -> setbitmap -> attach[ldc] -> destroy\n";
        vecStrIn.clear();
        ParseStrings("2 1", vecStrIn);
        TestCase006(inStrings, strOut, 0);

        // testcase007
        strOut += "create[osd] -> getcanvas -> update -> attach -> destroy\n";
        vecStrIn.clear();
        ParseStrings("0", vecStrIn);
        TestCase007(inStrings, strOut, 0);
        ...
        // testcase008
        strOut += "create[max] -> setbitmap[max] -> attach[vpe chn 0 port 0] -> dettach[vpe chn 0 port 0] -> destroy[max]\n";
        TestCase008(inStrings, strOut, 0);

        // testcase09
        strOut += "create[max] -> setbitmap[max] -> attach[max] -> -> destroy[max]";
        TestCase009(inStrings, strOut, 0);

        // testcase10
        strOut += "create[max] -> setbitmap[max] -> attach[max] -> detach[max] -> destroy[max]";
        TestCase010(inStrings, strOut, 0);
    }
}

void Mdb_Region::Init(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MDB_EXPECT_OK("MI_RGN_Init", strOut, MI_RGN_Init(&_gstPaletteTable), MI_RGN_OK);
}
void Mdb_Region::Deinit(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MDB_EXPECT_OK("MI_RGN_Deinit", strOut, MI_RGN_DeInit(), MI_RGN_OK);
}
void Mdb_Region::Create(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
...
void Mdb_Region::Destroy(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hHandle;
    hHandle = (MI_RGN_HANDLE)Atoi(inStrings[0]);
...
void Mdb_Region::AttachCover(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hHandle;
...
void Mdb_Region::AttachOsd(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hHandle;
    MI_RGN_ChnPort_t stChnPort;
    MI_RGN_ChnPortParam_t stChnAttr;
...
void Mdb_Region::Dettach(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hHandle;
    MI_RGN_ChnPort_t stChnPort;
...
void Mdb_Region::GetAttr(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hHandle;
    MI_RGN_Attr_t stRegion;
...
void Mdb_Region::SetCoverDisplayAttr(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hHandle;
    MI_RGN_ChnPort_t stChnPort;
...
void Mdb_Region::SetOsdDisplayAttr(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hHandle;
    MI_RGN_ChnPort_t stChnPort;
    MI_RGN_ChnPortParam_t stChnPortAttr;
...
void Mdb_Region::SetBitMap(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_HANDLE hHandle = 0;
    MI_U8 u8FileId = 0;
    MI_U8 u8PixelType = 0;
...
void Mdb_Region::SetCanvas(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_HANDLE hHandle = 0;
    MI_U8 u8FileId = 0;
    MI_U8 u8PixelType = 0;
...
void Mdb_Region::GetCanvas(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
...
void Mdb_Region::UpdateCanvas(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hHandle;
    hHandle = (MI_RGN_HANDLE)Atoi(inStrings[0]);
...
// create 1 -> destroy 1
void Mdb_Region::TestCase001(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
...
void Mdb_Region::TestCase002(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    std::stringstream ss;
    MI_S32 s32ErrorCode;
    ...
    while(1)
    {
        ...
        if (s32ErrorCode != MI_RGN_OK)
        {
            ...
            {
                SetDefaultParam();
                ClearRegion(inStrings, strOut, 0);
                return;
            }
        }
        _ghHandle++;
...
void Mdb_Region::TestCase003(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    std::stringstream ss;
    ...
    MDB_EXPECT_OK_ERRCASE(ss.str(), strOut, MI_RGN_Create(_ghHandle, &_gstRgnAttr), MI_RGN_OK,
            {SetDefaultParam();ClearRegion(inStrings, strOut, 0);return;};);
    ss.str("");
...
void Mdb_Region::TestCase004(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_U32 u32MaxChl = 0;
    ...
    switch(_gstChnPort.eModId)
    {
        ...
        case E_MI_RGN_MODID_DIVP:
            ...
            strPortType = "Divp";
            break;
        case E_MI_RGN_MODID_LDC:
            u32MaxChl = (MI_U32)MDB_RGN_LDC_MAX_CH_NUM;
            u32MaxOutPort = (MI_U32)MDB_RGN_LDC_PORT_MAXNUM;
            strPortType = "Ldc";
            break;
        default:
...
void Mdb_Region::TestCase005(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    std::string strRgnType;
    ...
    for (MI_U8 i = 0; i < u8RgnMaxNum+1; i++)
    {
        ...
        if (u8RgnMaxNum == i)
        {
            if (E_MI_RGN_TYPE_COVER == _gstRgnAttr.eType)
            {
                MDB_EXPECT_FAIL_ERRCASE(ss.str(), strOut, MI_RGN_AttachToChn(_ghHandle, &_gstChnPort, &_gstChnPortParam), MI_RGN_OK, SetDefaultParam();ClearRegion(inStrings, strOut, 0);return;);
            }
            else
            {
                MDB_EXPECT_FAIL_ERRCASE(ss.str(), strOut, MI_RGN_AttachToChn(_ghHandle, &_gstChnPort, &_gstChnPortParamOsd), MI_RGN_OK, SetDefaultParam();ClearRegion(inStrings, strOut, 0);return;);
            }
            break;
        }
        else
        {
            if (E_MI_RGN_TYPE_COVER == _gstRgnAttr.eType)
            {
                MDB_EXPECT_OK_ERRCASE(ss.str(), strOut, MI_RGN_AttachToChn(_ghHandle, &_gstChnPort, &_gstChnPortParam), MI_RGN_OK, SetDefaultParam();ClearRegion(inStrings, strOut, 0);return;);
            }
            else
            {
                MDB_EXPECT_OK_ERRCASE(ss.str(), strOut, MI_RGN_AttachToChn(_ghHandle, &_gstChnPort, &_gstChnPortParamOsd), MI_RGN_OK, SetDefaultParam();ClearRegion(inStrings, strOut, 0);return;);
            }
        }
...
void Mdb_Region::TestCase006(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_U8 u8FileId = 0;
    std::vector<std::string> vecStrIn;
    std::string strPortType;
...
void Mdb_Region::TestCase007(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
...
// create osd*max -> setbitmap ->attach -> dettach -> destroy*max
void Mdb_Region::TestCase008(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    char szParamIn[64];
    std::vector<std::string> vecStrIn;
...
void Mdb_Region::TestCase009(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    std::vector<std::string> vecStrIn;
    std::stringstream ss;
    std::string strPortType;
    ...
    for (MI_U8 i = 0; i < MDB_RGN_OSD_MAX_NUM; i++)
    {
        ...
        vecStrIn.clear();
        memset(szParamIn, 0, sizeof(szParamIn));
        sprintf(szParamIn, "%d %d", (MI_U8)_ghHandle, u8FileId);
        ParseStrings(szParamIn, vecStrIn);
...
void Mdb_Region::TestCase010(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    std::vector<std::string> vecStrIn;
    std::stringstream ss;
    char szParamIn[64];
    ...
    // vpe
    for (MI_U8 i = 0; i < MDB_RGN_VPE_PORT_MAXNUM ; i++)
    {
        for (MI_U8 j = 0; j < MDB_RGN_VPE_MAX_CH_NUM; j++)
        {
            vecStrIn.clear();
            memset(szParamIn, 0, sizeof(szParamIn));
            sprintf(szParamIn, "%d %d %d", (MI_U8)E_MI_RGN_MODID_VPE, j, i);
            ParseStrings(szParamIn, vecStrIn);
            MDB_RGN_USE_SingleTestCase(OneChnOnePortSetBitmap, vecStrIn, strOut);
        }
    }
    ...
    // divp
    for (MI_U8 i = 0; i < MDB_RGN_DIVP_PORT_MAXNUM; i++)
    {
        for (MI_U8 j = 0; j < MDB_RGN_DIVP_MAX_CH_NUM; j++)
        {
            vecStrIn.clear();
            memset(szParamIn, 0, sizeof(szParamIn));
            sprintf(szParamIn, "%d %d %d", (MI_U8)E_MI_RGN_MODID_DIVP, j, i);
            ParseStrings(szParamIn, vecStrIn);
            MDB_RGN_USE_SingleTestCase(OneChnOnePortSetBitmap, vecStrIn, strOut);
        }
    }
    ...
    // Ldc
    for (MI_U8 i = 0; i < MDB_RGN_LDC_PORT_MAXNUM ; i++)
    {
        for (MI_U8 j = 0; j < MDB_RGN_LDC_MAX_CH_NUM; j++)
        {
            vecStrIn.clear();
            memset(szParamIn, 0, sizeof(szParamIn));
            sprintf(szParamIn, "%d %d %d", (MI_U8)E_MI_RGN_MODID_LDC, j, i);
            ParseStrings(szParamIn, vecStrIn);
            MDB_RGN_USE_SingleTestCase(OneChnOnePortSetBitmap, vecStrIn, strOut);
        }
    }
...
void Mdb_Region::TestCase011(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    std::string strRgnType;
    std::string strOutPortType;
    std::stringstream ss;
...
void Mdb_Region::OneRegionOneAttach(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
...
void Mdb_Region::OneRegionMaxAttach(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hHandle = 233;
    MI_RGN_Attr_t stRgnAttr;
    MI_RGN_ChnPort_t stChnPort;
...
void Mdb_Region::MaxRegionMaxAttach(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{

}

void Mdb_Region::OneChnOnePortSetBitmap(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    std::vector<std::string> vecStrIn;
    std::stringstream ss;
    std::string strPortType;
    ...
    for (i = 0; i < MDB_RGN_OSD_MAX_NUM; i++)
    {
        ...
        _gstRgnAttr.stOsdInitParam.stSize.u32Width = _gstSize[0].u32Width;
        _gstRgnAttr.stOsdInitParam.stSize.u32Height = _gstSize[0].u32Height;
        ss.str("");
        ss << "MI_RGN_Create" << "(OsdRgn[" << _ghHandle << "])";
        MDB_EXPECT_OK_ERRCASE(ss.str(), strOut, MI_RGN_Create(_ghHandle, &_gstRgnAttr), MI_RGN_OK,
            {SetDefaultParam();ClearRegion(inStrings, strOut, 0);return;});

        u32OffsetX = u32OffsetY = i * 8;
        _gstChnPortParamOsd.stPoint.u32X = u32OffsetX;
        _gstChnPortParamOsd.stPoint.u32Y = u32OffsetY;


        RUN_COMMAND(SetBitMap, strOut, "%d 0 0", (MI_U8)_ghHandle);
...
void Mdb_Region::MaxRegion(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_Attr_t stRgnAttr;
...
void Mdb_Region::ClearRegion(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    std::stringstream ss;
    MI_S32 s32ErrCode;
...
void Mdb_Region::CreateAttachDetechDestroy(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hHandle = 233;
    MI_RGN_Attr_t stRgnAttr;
    MI_RGN_ChnPort_t stChnPort;
...
void Mdb_Region::SetDefaultParam()
{
    ...
    memset(&_gstChnPortParam, 0 , sizeof(MI_RGN_ChnPortParam_t));
    ...
    memset(&_gstChnPortParamOsd, 0 , sizeof(MI_RGN_ChnPortParam_t));
    ...
    _gstChnPortParamOsd.unPara.stOsdChnPort.stOsdAlphaAttr.stAlphaPara.stArgb1555Alpha.u8FgAlpha = 0xFF;

    _gvecStrIn.clear();
}
void Mdb_Region::SelectFillDataMode(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
...
void Mdb_Region::VpeDivpAddData(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    ...
    ParseStrings(ss.str().c_str(), vecStrIn);
    if (bSelectMode)
        SetCanvas(vecStrIn, strOut, 0);
    else
        SetBitMap(vecStrIn, strOut, 0);
    vecStrIn.clear();
    ss.str("");
...
void Mdb_Region::VpeDivpAttachData(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    std::vector<std::string> vecStrIn;
    std::stringstream ss;
...
void Mdb_Region::VpeDivpRmData(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    std::vector<std::string> vecStrIn;

    ParseStrings("0", vecStrIn);
    Destroy(vecStrIn, strOut, 0);
    vecStrIn.clear();
    ParseStrings("1", vecStrIn);
    Destroy(vecStrIn, strOut, 0);
    vecStrIn.clear();
...
void Mdb_Region::VpeDivpProcess(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    std::vector<std::string> vecStrIn;
    std::stringstream ss;
    ...
    for (i = 0; i < PROCESS_CNT; i++)
    {
        for (j = 0; j < intMaxChn; j++)
        {
            for (k = 0; k < 4; k++)
            {
                ...
                ParseStrings(ss.str().c_str(), vecStrIn);
                SetOsdDisplayAttr(vecStrIn, strOut, 0);
                vecStrIn.clear();
                ss.str("");
                ...
                ParseStrings(ss.str().c_str(), vecStrIn);
                SetCoverDisplayAttr(vecStrIn, strOut, 0);
                vecStrIn.clear();
                ss.str("");
...
void Mdb_Region::InjectCover(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
...
void Mdb_Region::InjectPic(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    int fd = 0;
...
void Mdb_Region::ElicitWord(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
...
void Mdb_Region::InjectWord(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hRgnHandle;
...
void Mdb_Region::UpdateWord(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hRgnHandle;
    ST_Point_T stPoint;
    MI_RGN_CanvasInfo_t *pstCanvasInfo;
...
void Mdb_Region::SetOsdPos(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hRgnHandle = Atoi(inStrings[0]);
    MI_RGN_ChnPort_t stChnPort;
    MI_RGN_ChnPortParam_t stChnPortAttr;
...
void Mdb_Region::SetOnOff(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hRgnHandle = Atoi(inStrings[0]);
    MI_RGN_ChnPort_t stChnPort;
    MI_RGN_ChnPortParam_t stChnPortAttr;
...
void Mdb_Region::SetOsdLayer(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hRgnHandle = Atoi(inStrings[0]);
    MI_RGN_ChnPort_t stChnPort;
    MI_RGN_ChnPortParam_t stChnPortAttr;
...
void Mdb_Region::SetOsdAlpha(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hRgnHandle = Atoi(inStrings[0]);
    MI_RGN_ChnPort_t stChnPort;
    MI_RGN_ChnPortParam_t stChnPortAttr;
...
void Mdb_Region::SetCoverColor(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hRgnHandle = Atoi(inStrings[0]);
    MI_RGN_ChnPort_t stChnPort;
    MI_RGN_ChnPortParam_t stChnPortAttr;
...
void Mdb_Region::SetCoverLayer(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hRgnHandle = Atoi(inStrings[0]);
    MI_RGN_ChnPort_t stChnPort;
    MI_RGN_ChnPortParam_t stChnPortAttr;
...
void Mdb_Region::SetRamdomPos(std::vector<std::string> &inStrings, std::string &strOut, int bShowHelp)
{
    MI_RGN_HANDLE hRgnHandle = Atoi(inStrings[0]);
    MI_RGN_ChnPort_t stChnPort;
    MI_RGN_ChnPortParam_t stChnPortAttr;
