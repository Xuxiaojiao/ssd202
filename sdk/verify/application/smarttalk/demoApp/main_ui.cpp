        ...
        case MSG_ERASEBKGND:
            {
                ...
                DeleteCompatibleDC(hdcMem);
            #else
                SetBrushColor ((HDC)wParam, WINDOW_BGCOLOR((HDC)wParam));
                FillBox ((HDC)wParam, 0, 0, g_s32UiMainWnd_W, g_s32UiMainWnd_H);
            #endif
            }
            return 1;
        case MSG_DESTROY:
        ...
        case MSG_ERASEBKGND:
            {
                ...
                SetBrushColor ((HDC)wParam, WINDOW_BGCOLOR((HDC)wParam));
                FillBox ((HDC)wParam, 0, 0, g_s32UiMainWnd_W, g_s32UiMainWnd_H);
                SetBrushColor ((HDC)wParam, RGBA2Pixel((HDC)wParam, 0x80, 0x80, 0x80, 0x80));
                FillBox ((HDC)wParam, stCalledItem[3].s32X, stCalledItem[3].s32Y, stCalledItem[3].s16PicW, stCalledItem[3].s16PicH);
            #endif
            }
            return 1;
        case MSG_DESTROY:
        ...
        case MSG_ERASEBKGND:
            {
                ...
                FillBox ((HDC)wParam, 0, 0, g_s32UiMainWnd_W, g_s32UiMainWnd_H);
                SetBrushColor ((HDC)wParam, RGBA2Pixel((HDC)wParam, 0x80, 0x80, 0x80, 0x80));
                FillBox ((HDC)wParam, stCallItem[2].s32X, stCallItem[2].s32Y, stCallItem[2].s16PicW, stCallItem[2].s16PicH);
            #endif
            }
            return 1;
        case MSG_DESTROY:
        ...
        case MSG_ERASEBKGND:
            {
                ...
                FillBox ((HDC)wParam, 0, 0, g_s32UiMainWnd_W, g_s32UiMainWnd_H);
                SetBrushColor ((HDC)wParam, RGBA2Pixel((HDC)wParam, 0x80, 0x80, 0x80, 0x80));
                FillBox ((HDC)wParam, stCallItem[1].s32X, stCallItem[1].s32Y, stCallItem[1].s16PicW, stCallItem[1].s16PicH);
            #endif
            }
            return 1;
        case MSG_DESTROY:
